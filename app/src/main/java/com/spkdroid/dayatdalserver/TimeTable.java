 ...
 *         This class is used to show the time table information of the user. Based on the user id the kiosk will send a request
 *         to the server and the server in turn will respond back to the client with the TimeTable Information.
 *         <p/>
 *         The Webservice are Fetch TimeTable Service
 *         <p/>
 *         http://www.spkdroid.com/merlin/timetable.php?login_id=<user id>
 */
public class TimeTable extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * The AsyncTask Below will assemble the URL and will hit the server in the background and will be waiting for the
         *
         * response from the server. When the server replies with the data. The TimeTable Detail are displayed in the screen.
         *
         * This is a Background Process that will also be showing a  progress bar in the screen.
         *
         *
         */
    ...
    /**
     * When the user press the back button the activity is killed and is redirected to the menu screen.
     */
